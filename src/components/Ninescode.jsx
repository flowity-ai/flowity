...
const Ninescode = () => (
	<section id="community" className={layout.sectionReverse}>
		...
		{/* gradient start */}
		<div className="absolute z-[3] -right-1/2 top-[360em] w-[50%] h-[50%] rounded-full white__gradient" />
		<div className="absolute z-[0] w-[50%] h-[50%] -right-1/2 bottom-[360em] rounded-full pink__gradient" />
		{/* gradient end */}
	</section>
);
