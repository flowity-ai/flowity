						...
						<div className="space-y-8">
							...
							<div className="flex">
								...
								<div>
									...
									<p className="text-gray-300 mb-3">
										Advanced systems identify patterns and relationships across
							...
							<div className="flex">
								...
								<div>
									...
									<p className="text-gray-300">
										Our adaptive intelligence improves its understanding of your
										business context with each analysis cycle
									</p>
								</div>
							</div>
						</div>
							...
							<div className="space-y-8">
								...
								<div className="flex items-start">
									...
									<div className="ml-4">
										...
										<p className="text-gray-300 mb-3">
											Track customer satisfaction across product areas over time
										</p>
							...
							<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
								<div className="bg-gray-800 rounded-xl p-5 border border-gray-600">
									...
									<p className="text-gray-300 text-sm">
										Comprehensive analysis delivered to Notion with prioritized
										actions
									</p>
								</div>
